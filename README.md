...
## 📸 Trực quan hóa giao diện (Demo)

*(Mẹo: Bạn hãy kéo thả ảnh chụp màn hình ứng dụng hoặc file GIF minh họa vào đây khi edit trên GitHub)*

![Giao diện chính của ứng dụng](đường_dẫn_ảnh_giao_diện_chính.png)
*Minh họa: Giao diện thêm, xóa và tra cứu từ vựng đa nghĩa.*

![Chế độ trực quan hóa Radix-Trie](đường_dẫn_ảnh_visualization.gif)
*Minh họa: Cấu trúc cây tự động tách/gộp (Split/Merge node) trong thời gian thực.*
